...
`harvest/1.2` · contact `harvest@example.invalid` · budget **120** · **0** requests · **902** proposals

## Expected cost

- Seed: **119** works · **511** candidates · **0** already have an mbid
- Budget cap: **120** requests (MusicBrainz ~1 req/s; CAA ~0.6s gap)
- This run: **0** network requests
- Wall-clock if live: ~1–30s under polite rate limits
...
- Identity proposals: **392** / 511 candidates
- `auto_accept_eligible` (confidence ≥ 80, no compilation/date flags): **102**
- Uncertain / must stay for human review: **290**
- Unresolved (no MusicBrainz hit this run): **119**
...
| `bach/john/0` | Otto Klemperer; EMI, 1961 | St. Matthew Passion (1962) | 100 | yes |  |
| `bach/john/2` | Nikolaus Harnoncourt; Teldec, 1965 | Matthäus-Passion (1971) | 45 | **no** | confidence 45 < 80; date off by 6 years (1965 vs 1971) |
| `bach/art_of_fugue/0` | Glenn Gould; CBS, 1962 | The Art of the Fugue (1962) | 84 | **no** | wrong work: MusicBrainz 'The Art of the Fugue' does not match seed 'The Art of Fugue' |
...
| `chopin/sonata2/0` | Arthur Rubinstein; RCA, 1961 | The Rubinstein Collection, Volume 5: Piano Concertos nos. 1 & 2 / 19 Nocturnes (2001-08-07) | 76 | **no** | confidence 76 < 80; date off by 40 years (1961 vs 2001); compilation-like title: 'The Rubinstein Collection, Volume 5: Piano Concertos nos. 1 & 2 / 19 Nocturnes' |
| `chopin/pc1/1` | Stanisław Skrowaczewski; RCA, 1961 | Piano Concertos No. 1 & 2 (2001) | 80 | **no** | date off by 40 years (1961 vs 2001) |
| `chopin/pc2/0` | Stanisław Skrowaczewski; RCA, 1958 | Brahms: Piano Concerto no. 2 / Variations on a Theme by Paganini, Book 2 / Liszt: Hungarian Rhapsody no. 12 / Beethoven: Sonata, op. 14 no. 1 (1994) | 100 | **no** | date off by 36 years (1958 vs 1994) |
...
| `bach/john/4` | Philippe Herreweghe; Harmonia Mundi, 1990s | Matthäus-Passion, BWV 244 (1985) | 44 | **no** | confidence 44 < 80; date off by 5 years (1990 vs 1985) |
| `bach/art_of_fugue/2` | Davitt Moroney; Harmonia Mundi, 2000 | L'Art de la Fugue (1985) | 100 | **no** | date off by 15 years (2000 vs 1985); wrong work: MusicBrainz "L'Art de la Fugue" does not match seed 'The Art of Fugue' |
...
| `beethoven/hammerklavier/1` | Sviatoslav Richter; Philips, 1970s | Sonata no. 29 "Hammerklavier" / Sonata no. 3 / Bagatelles, op. 126 (2000) | 100 | **no** | date off by 30 years (1970 vs 2000) |
...
| `mozart/late_symphonies/3` | Leonard Bernstein; Deutsche Grammophon, 1980s | Symphonien Nos. 40 & 41 "Jupiter" (1990) | 100 | **no** | date off by 10 years (1980 vs 1990); wrong work: MusicBrainz 'Symphonien Nos. 40 & 41 "Jupiter"' does not match seed 'Symphonies Nos. 39, 40, 41' |
...
| `mozart/clarinet_concerto/2` | Claudio Abbado; Deutsche Grammophon, 1990s | Flute Concerto no. 1 / Concerto for Flute and Harp / Clarinet Concerto (2001-04-01) | 100 | **no** | date off by 11 years (1990 vs 2001) |
...
| `mozart/mass_c_minor/1` | Neville Marriner; Philips, 1970s | Mass in B minor (1986-03-21) | 41 | **no** | confidence 41 < 80; date off by 16 years (1970 vs 1986) |
...
| `bach/john/3` | Karl Richter; Archiv, 1964 | Matthäus-Passion (1980) | 64 | **no** | confidence 64 < 80; date off by 16 years (1964 vs 1980) |
...
| `brahms/violin_concerto/0` | Otto Klemperer; EMI, 1960 | Violinkonzert (1961) | 65 | **no** | confidence 65 < 80 |
...
| `haydn/creation/0` | Herbert von Karajan; Deutsche Grammophon, 1969 | Die Schöpfung (1991) | 100 | **no** | date off by 22 years (1969 vs 1991); wrong work: MusicBrainz 'Die Schöpfung' does not match seed 'The Creation' |
...
| `chopin/etudes/0` | Maurizio Pollini; Deutsche Grammophon, 1972 | Études op. 10 & op. 25 (1973) | 95 | **no** | wrong work: MusicBrainz 'Études op. 10 & op. 25' does not match seed 'Études' |
| `chopin/sonata3/1` | Arthur Rubinstein; RCA, 1961 | The Rubinstein Collection, Volume 65: Brahms: Piano Quartets Nos. 1 & 3 (1999) | 63 | **no** | confidence 63 < 80; date off by 38 years (1961 vs 1999); compilation-like title: 'The Rubinstein Collection, Volume 65: Brahms: Piano Quartets Nos. 1 & 3' |
...
| `bach/cello_suites/4` | Mstislav Rostropovich; EMI, 1991 | Cello Suites 1 & 2 / Cello Sonata (1989) | 74 | **no** | confidence 74 < 80 |
...
| `bach/art_of_fugue/3` | Emerson String Quartet; Deutsche Grammophon, 2003 | The Art of Fugue (2003-08-01) | 100 | **no** | wrong work: MusicBrainz 'The Art of Fugue' does not match seed 'The Art of Fugue' |
...
| `beethoven/pc4/1` | Claudio Abbado; Deutsche Grammophon, 1979 | Piano Concertos Nos. 21 & 27 (1990) | 100 | **no** | date off by 11 years (1979 vs 1990) |
...
| `mozart/pc27/3` | Alfred Brendel; Philips, 1990s | Piano Concertos Nos. 19 & 27; Rondo K. 386 (2020-08-21) | 100 | **no** | date off by 30 years (1990 vs 2020) |
...
| `mozart/mass_c_minor/2` | Karl Böhm; Deutsche Grammophon, 1960s | Symphony No. 5 in E minor (1989) | 83 | **no** | date off by 29 years (1960 vs 1989) |
| `mozart/mass_c_minor/4` | Christopher Hogwood; L'Oiseau-Lyre, 1980s | Symphony No. 9 in D minor (1989) | 64 | **no** | confidence 64 < 80; date off by 9 years (1980 vs 1989) |
...
| `brahms/piano_quintet/1` | Sviatoslav Richter; Borodin Quartet; EMI, 1983 | FRANCK: Piano Quintet / LISZT: Pensées des morts · Andante lagrimoso · Ave Maria (1991) | 69 | **no** | confidence 69 < 80; date off by 8 years (1983 vs 1991) |
...
| `haydn/creation/1` | John Eliot Gardiner; Archiv, 1996 | Die Schöpfung (1997-01-03) | 100 | **no** | wrong work: MusicBrainz 'Die Schöpfung' does not match seed 'The Creation' |
...
| `haydn/trumpet_concerto/0` | Riccardo Muti; EMI, 1980s | Bach: Brandenburg Concerto No. 2 / Haydn, Telemann & Torelli: Trumpet Concertos (1985) | 100 | **no** | date off by 5 years (1980 vs 1985) |
...
| `haydn/seasons/1` | John Eliot Gardiner; Archiv, 1992 | Die Jahreszeiten (1992-03-02) | 100 | **no** | wrong work: MusicBrainz 'Die Jahreszeiten' does not match seed 'The Seasons' |
...
| `haydn/sym45/0` | Antal Doráti; Decca, 1970s | Mozart: Symphony no. 40 / Haydn: Symphony no. 45 “Farewell” (1962-12) | 100 | **no** | date off by 8 years (1970 vs 1962) |
| `schubert/sym8/0` | Carlos Kleiber; Deutsche Grammophon, 1978 | Symphonien nos. 3 & 8 »Unvollendete« (1997-02-04) | 100 | **no** | date off by 19 years (1978 vs 1997); wrong work: MusicBrainz 'Symphonien nos. 3 & 8 »Unvollendete«' does not match seed 'Symphony No. 8, Unfinished' |
...
| `schubert/sonata_d960/0` | Arturo Benedetti Michelangeli; Deutsche Grammophon, 1981 | Beethoven: Piano Sonata no. 12 in A-flat / Piano Sonata no. 4 in E-flat / Debussy: Images: Hommage à Rameau / Ravel: Gaspard de la nuit (2002) | 100 | **no** | date off by 21 years (1981 vs 2002) |
| `schubert/sonata_d960/2` | Maurizio Pollini; Deutsche Grammophon, 1987 | Piano Sonatas No. 28 in A major, Op. 101 & No. 29 in B flat major, Op. 106 "Hammerklavier" (1990) | 100 | yes |  |
| `schubert/sonata_d960/4` | Murray Perahia; Sony, 1990s | Sonatas: No. 2 in B-flat major, op. 35 / No. 3 in B minor, op. 58 (1988-10-04) | 86 | yes |  |
| `schubert/mass_e_flat/0` | Wolfgang Sawallisch; EMI, 1970s | Mass in A flat major / Mass in C major (1983) | 100 | **no** | date off by 13 years (1970 vs 1983) |
| `schubert/mass_e_flat/1` | John Eliot Gardiner; Philips, 1990s | Mass in A-flat, D. 678 (1999) | 100 | **no** | date off by 9 years (1990 vs 1999) |
| `schubert/mass_e_flat/2` | Wolfgang Sawallisch; EMI, 1980s | Mass in A flat major / Mass in C major (1983) | 100 | yes |  |
| `schubert/mass_e_flat/3` | Philippe Herreweghe; Harmonia Mundi, 1990s | Symphony No. 4 in E-flat major, "Romantic" (2006) | 100 | **no** | date off by 16 years (1990 vs 2006) |
...
| `schubert/rosamunde/1` | Claudio Abbado; Deutsche Grammophon, 1980s | Prometheus: The Myth in Music (1994-10) | 70 | **no** | confidence 70 < 80; date off by 14 years (1980 vs 1994) |
| `schubert/rosamunde/3` | John Eliot Gardiner; Archiv, 1990s | Music for the Royal Fireworks / Orchestral Works (1992) | 100 | yes |  |
...
| `handel/water_music/2` | Nikolaus Harnoncourt; Teldec, 1990s | Music at the Court of Mannheim (1992) | 30 | **no** | confidence 30 < 80 |
...
| `handel/op6/3` | Charles Mackerras; Decca, 1970s | Pergolesi: Stabat Mater / Scarlatti: Stabat Mater / 6 Concerti grossi (1999-05-03) | 100 | **no** | date off by 29 years (1970 vs 1999) |
...
| `chopin/preludes/0` | Martha Argerich; Deutsche Grammophon, 1977 | 26 Preludes / 3 Mazurkas op. 59 / Scherzo op. 39 (None) | 97 | yes |  |
...
| `chopin/sonata2/3` | Claudio Arrau; Philips, 1970s | Piano Sonatas Op. 13, "Pathetique" and Op. 2 No.3 (1986) | 100 | **no** | date off by 16 years (1970 vs 1986) |
| `chopin/sonata3/0` | Martha Argerich; Deutsche Grammophon, 1960s | Martha Argerich Collection, Volume 3: Solo Works & Works for Piano Duo (1997-03-14) | 78 | **no** | confidence 78 < 80; date off by 37 years (1960 vs 1997); compilation-like title: 'Martha Argerich Collection, Volume 3: Solo Works & Works for Piano Duo' |
| `chopin/sonata3/2` | Maurizio Pollini; Deutsche Grammophon, 1980s | Piano Concerto no. 3 / Piano Sonata no. 31 (1978) | 79 | **no** | confidence 79 < 80 |
| `chopin/sonata3/3` | Claudio Arrau; Philips, 1970s | The Piano Concertos / 3 Etudes de Concert (1986) | 58 | **no** | confidence 58 < 80; date off by 16 years (1970 vs 1986) |
...
| `chopin/nocturnes/1` | Claudio Arrau; Philips, 1978 | The Nocturnes (1978) | 100 | **no** | wrong work: MusicBrainz 'The Nocturnes' does not match seed 'Nocturnes' |
...
| `schubert/sonata_d960/1` | Alfred Brendel; Philips, 1970s | Piano Concerto no. 4 / Rondo in B-flat / "Pathétique" Sonata (1986) | 59 | **no** | confidence 59 < 80; date off by 16 years (1970 vs 1986) |
| `schubert/rosamunde/0` | Willi Boskovsky; Decca, 1960s | Eine kleine Nachtmusik / Serenata / Notturna / A Musical Joke (1991) | 87 | **no** | date off by 31 years (1960 vs 1991) |
| `schubert/rosamunde/2` | Karl Böhm; Deutsche Grammophon, 1960s | Symphonies nos 29 & 35 "Haffner" / Masonic Funeral Music (None) | 100 | yes |  |
...
| `handel/agrippina/0` | John Eliot Gardiner; Philips, 1990s | Agrippina: Highlights (1998-05) | 92 | **no** | date off by 8 years (1990 vs 1998); compilation-like title: 'Agrippina: Highlights' |
| `handel/agrippina/2` | Maxim Emelyanychev; Erato, 2020 | Agrippina (2020-01-31) | 100 | yes |  |
| `chopin/etudes/1` | Murray Perahia; Sony, 2002 | Études: Op. 10 / Op. 25 (2002-09-17) | 100 | **no** | wrong work: MusicBrainz 'Études: Op. 10 / Op. 25' does not match seed 'Études' |
| `chopin/etudes/3` | Vladimir Ashkenazy; Deutsche Grammophon, 1970s | Etudes Op. 10 & Op. 25 (1984) | 100 | **no** | date off by 14 years (1970 vs 1984); wrong work: MusicBrainz 'Etudes Op. 10 & Op. 25' does not match seed 'Études' |
...
| `chopin/sonata2/2` | Martha Argerich; Deutsche Grammophon, 1984 | Piano Concertos 1 & 2 (1986) | 67 | **no** | confidence 67 < 80 |
| `chopin/nocturnes/0` | Arthur Rubinstein; RCA, 1965–67 | Nocturnes (1999) | 100 | **no** | date off by 34 years (1965 vs 1999); wrong work: MusicBrainz 'Nocturnes' does not match seed 'Nocturnes' |
| `chopin/nocturnes/2` | Maria João Pires; Deutsche Grammophon, 1990s | Nocturnes (1996-10-01) | 100 | **no** | date off by 6 years (1990 vs 1996); wrong work: MusicBrainz 'Nocturnes' does not match seed 'Nocturnes' |
...
| `schubert/sonata_d960/3` | Daniel Barenboim; Deutsche Grammophon, 1980s | Sinfonia Concertante in E-Flat K.364; Concertone in C Major K.190; Sinfonia Concertante In D Major; Sinfonie Concertante In B-Flat Op.29 (1985) | 60 | **no** | confidence 60 < 80; date off by 5 years (1980 vs 1985) |
